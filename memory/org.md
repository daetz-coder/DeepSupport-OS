...
Stable tenant / demo facts (Deep Agents virtual path `/memory/org.md`).
Prefer editing this file for org-level context; keep per-thread notes in `threads/{tid}/AGENTS.md`.
